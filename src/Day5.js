...
1 byte => 8 bits (hold multiple or may characters)
+
3 byte => 24 bits (32 bits of memory to hold any string)

RAM = 64kb 

65536 - last 12 bits (65524)

arr[n] = n should be of type integer (65536/2) =>32767 to 32768 
...
const hexaColor = () => {
  let str = "0123456789abcdef"; //16 digits
  let color = "";
  let n = 6;
  for (let i = 0; i < n; i++) {
...
// User Card Component - Supporting Comp
const UserCard = () => (
